...
if st.button("Load Data and Analyze"):
    # Load data
    @st.cache_data
    def load_stock_data(selected_stock=selected_stock):
        try:
    ...
    if data is not None:
        ...
        # Change color of suggestion box
    ...
    real_time_stock_data = get_real_time_stock_data(realtime_api_key, selected_stock)
